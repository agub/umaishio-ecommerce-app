		...
		<div style={{ backgroundColor: '#f5f5f5' }}>
			...
			<Container>
				...
				<RightPicture
					...
					title='味噌'
					content='1300年もの長い間、日本人の食生活を支えてきた伝統的な発酵食品である味噌。味噌は医者いらずと言われる程、たくさんの栄養が入っており、主原料の大豆には良質なたんぱく質やリノール酸、イソフラボンなどが含まれ、様々な健康効果が期待される食品です。酒粕と同様に乳酸菌や酵母も含まれるため、旨味に深みを持たせています。「旨い塩」シリーズの第一弾では、私達が厳選した味わい深いの長野県産の味噌を足すことで「旨味と栄養」を際立たせ、手軽に美味しく栄養を摂取する事ができます。'
				/>
				<LeftPicture
					imageXl={konbuXl}

			...
			<Container>
				...
				<RightPicture
					...
					content='『旨い塩』シリ－ズの要になる塩は、黒潮が通る伊豆大島近海の海水を、自然エネルギーを使い、日本伝統の塩田製塩法で作り上げた塩を基に作られています。
						その塩を伊勢神宮に伝わる日本古来の塩壺焼成法により600℃の高温で焼き上げ、ニガリ成分を分解し、栄養成分であるマグネシウム量はそのままの「焼塩」にした手間のかかった塩を使っています。焼塩にすることで塩味のバランスも良く、角が取れた甘みのある、マイルドであっさりとした味わいになり、その上さらさらの質感なので料理の味の邪魔をせず、素材の味を引き立たせます。'
				/>
				...
				<RightPicture
					...
					title='味噌'
					content='1300年もの長い間、日本人の食生活を支えてきた伝統的な発酵食品である味噌。味噌は医者いらずと言われる程、たくさんの栄養が入っており、主原料の大豆には良質なたんぱく質やリノール酸、イソフラボンなどが含まれ、様々な健康効果が期待される食品です。酒粕と同様に乳酸菌や酵母も含まれるため、旨味に深みを持たせています。「旨い塩」シリーズの第一弾では、私達が厳選した味わい深い長野県産の味噌を足すことで「旨味と栄養」を際立たせ、手軽に美味しく栄養を摂取する事ができます。'
				/>
				<LeftPicture
					imageXl={konbuXl}
					...
					海藻特有の水溶性食物繊維の『フコダイン』『アルギン酸』は糖質や脂肪の吸収を抑える、コレステロール値の上昇を抑えてくれると言われており、また『フコダイン』の腸から免疫力を高める作用も注目されています。旨い塩の大事な旨味と共に、栄養も目を見張るものがあります。'
				/>
